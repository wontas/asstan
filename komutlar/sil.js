...
exports.run = (client, message, args) => {
 ...
 message.channel.send(`<a:onaylandi:698113364026720267> Başarılı Bir Şekilde **${miktar}** Mesaj Silindi.`).then(msg => {msg.delete({ timeout: 5000 })}).catch(err => { 
   ...
   if(!sayı || isNaN(sayı)) {
	...
	.setColor("#5865f2")
	.setDescription(`<:red:939534786840637460> **Eğer mesajları silmemi istiyorsan lütfen silinicek mesaj miktarını belirt!**`)
   ...
   if(sayı > 100) {
	  const embed = new Discord.MessageEmbed()
	.setColor("#5865f2")
	.setDescription(`<:red:939534786840637460> **Üzgünüm ancak Discord kurallarına göre 100'den fazla mesaj silemem!**`)
   ...
   const embed = new Discord.MessageEmbed()
	.setColor("#5865f2")
	.setDescription(`<:onayland:939534786555441253> **Başarılı bir şekilde **${sayı}** Adet mesaj sildim!**`)
